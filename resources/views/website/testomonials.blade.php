...
$menus = App\Models\Navigation::find(	2446)
           ...
           <div class="flex flex-col items-center lg:flex-row">
               ...
               <div class="w-full lg:w-1/2">
                   @foreach ($testimonial as $testimonial_item)
                       <blockquote
                           class="flex items-center justify-between w-full col-span-1 p-6 bg-white rounded-lg hover:shadow-lg hover:cursor-pointer transition-all duration-300" style="margin: 20px">
                           <div class="flex flex-col pr-8">
                            ...
                            @if ($testimonial_item->banner_image)
                               ...
                               @else
                                   <img class="flex-shrink-0 w-20 h-20 bg-gray-300 rounded-full xl:w-24 xl:h-24"
                                       src=" https://demo.radiantnepal.info/nathm/assets/images/team/default-user.jpg"
                                       alt="" />
                               @endif
